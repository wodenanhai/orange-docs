<template><div><h1 id="_7-手写事件总线" tabindex="-1"><a class="header-anchor" href="#_7-手写事件总线"><span>7.手写事件总线</span></a></h1>
<h2 id="_7-1-api说明" tabindex="-1"><a class="header-anchor" href="#_7-1-api说明"><span>7.1.API说明</span></a></h2>
<ol>
<li>eventBus: 包含所有功能的事件总线对象</li>
<li>eventBus.on(eventName, listener): 绑定事件监听</li>
<li>eventBus.emit(eventName, data): 分发事件</li>
<li>eventBus.off(eventName): 解绑指定事件名的事件监听, 如果没有指定解绑所有</li>
</ol>
<h2 id="_7-2-编码实现" tabindex="-1"><a class="header-anchor" href="#_7-2-编码实现"><span>7.2.编码实现</span></a></h2>
<ul>
<li><code v-pre>src/event-bus/index.js</code></li>
</ul>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code class="language-javascript"><span class="line"><span class="token keyword">const</span> eventBus <span class="token operator">=</span> <span class="token punctuation">{</span><span class="token punctuation">}</span></span>
