<template><div><h1 id="_5-手写dom事件监听-带委托" tabindex="-1"><a class="header-anchor" href="#_5-手写dom事件监听-带委托"><span>5.手写DOM事件监听(带委托)</span></a></h1>
<h2 id="_5-1-理解事件冒泡与事件委托" tabindex="-1"><a class="header-anchor" href="#_5-1-理解事件冒泡与事件委托"><span>5.1. 理解事件冒泡与事件委托</span></a></h2>
<ul>
<li>事件冒泡的流程
<ul>
<li>基于DOM树形结构</li>
...
<p><img src="@source/tools/customize/img_1.png" alt="img_1.png"></p>
<ul>
<li>事件委托/代理
<ul>
<li>将多个子元素的同类事件监听委托给(绑定在)共同的一个父组件上</li>
<li>好处：
<ul>
<li>减少内存占用(事件监听回调从n变为</li>
<li>动态添加的内部元素也能响应</li>
</ul>
</li>
</ul>
...
<h2 id="_5-2-api-相关" tabindex="-1"><a class="header-anchor" href="#_5-2-api-相关"><span>5.2. API 相关</span></a></h2>
<ul>
<li>语法：addEventListener(element, type, fn, selector)</li>
<li>说明：如果selector没有，直接给element绑定事件，如果selector有，将selector对应的多个元素的事件委托绑定给父元素element</li>
</ul>
<h2 id="_5-3-编码实现" tabindex="-1"><a class="header-anchor" href="#_5-3-编码实现"><span>5.3.编码实现</span></a></h2>
<ul>
<li><code v-pre>src/event-bind/index.js</code></li>
</ul>
