<template><div><h1 id="_4-字符串相关" tabindex="-1"><a class="header-anchor" href="#_4-字符串相关"><span>4.字符串相关</span></a></h1>
<h2 id="_4-1-api相关" tabindex="-1"><a class="header-anchor" href="#_4-1-api相关"><span>4.1. API相关</span></a></h2>
<ul>
<li>字符串倒序
<ul>
<li>语法: reverseString(str)</li>
<li>功能: 生成一个倒序的字符串</li>
</ul>
</li>
<li>字符串是否是回文
<ul>
<li>语法: palindrome(str)</li>
<li>功能: 如果给定的字符串是回文，则返回 true ；否则返回 false</li>
</ul>
</li>
<li>截取字符串
<ul>
<li>语法: truncate(str, num)</li>
<li>功能: 如果字符串的长度超过了num, 截取前面num长度部分, 并以...结束</li>
</ul>
</li>
</ul>
<p>##4.2. 编码实现</p>
<ul>
<li><code v-pre>src/string/index.js</code></li>
</ul>
