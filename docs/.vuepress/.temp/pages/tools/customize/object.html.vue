<template><div><h1 id="_3-对象相关" tabindex="-1"><a class="header-anchor" href="#_3-对象相关"><span>3.对象相关</span></a></h1>
<h2 id="_3-1-相关api" tabindex="-1"><a class="header-anchor" href="#_3-1-相关api"><span>3.1.相关API</span></a></h2>
<ul>
<li>newInstance()</li>
<li>myInstanceOf()</li>
<li>mergeObject()</li>
<li>clone1() / clone2()</li>
<li>deepClone1() / deepClone2() / deepClone3() / deepClone4()</li>
</ul>
<h2 id="_3-2-自定义new" tabindex="-1"><a class="header-anchor" href="#_3-2-自定义new"><span>3.2.自定义new</span></a></h2>
<h3 id="_3-2-1-api-相关" tabindex="-1"><a class="header-anchor" href="#_3-2-1-api-相关"><span>3.2.1.API 相关</span></a></h3>
<ul>
<li>语法: newInstance(Fn, ...args)</li>
<li>功能: 创建Fn构造函数的实例对象</li>
</ul>
<h3 id="_3-2-3-编码实现" tabindex="-1"><a class="header-anchor" href="#_3-2-3-编码实现"><span>3.2.3.编码实现</span></a></h3>
<ul>
<li><code v-pre>src/object/newInstance.js</code></li>
</ul>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code class="language-javascript"><span class="line"><span class="token keyword">export</span> <span class="token keyword">function</span> <span class="token function">newInstance</span><span class="token punctuation">(</span><span class="token parameter">Fn<span class="token punctuation">,</span> <span class="token operator">...</span>args</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-3-自定义instanceof" tabindex="-1"><a class="header-anchor" href="#_3-3-自定义instanceof"><span>3.3.自定义instanceof</span></a></h2>
<h3 id="_3-3-1-api-相关" tabindex="-1"><a class="header-anchor" href="#_3-3-1-api-相关"><span>3.3.1. API 相关</span></a></h3>
<ul>
<li>语法: myInstanceOf(obj, Type)</li>
<li>功能: 判断obj是否是Type类型的实例</li>
<li>实现: Type的原型对象是否是obj的原型链上的某个对象, 如果是返回true, 否则返回false</li>
</ul>
<h3 id="_3-3-2-编码实现" tabindex="-1"><a class="header-anchor" href="#_3-3-2-编码实现"><span>3.3.2.编码实现</span></a></h3>
<ul>
<li><code v-pre>src/object/myInstanceOf.js</code></li>
</ul>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code class="language-javascript"><span class="line"><span class="token keyword">export</span> <span class="token keyword">function</span> <span class="token function">myInstanceOf</span><span class="token punctuation">(</span><span class="token parameter">obj<span class="token punctuation">,</span> Type</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>html</span><span class="token punctuation">></span></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-4-合并多个对象" tabindex="-1"><a class="header-anchor" href="#_3-4-合并多个对象"><span>3.4.合并多个对象</span></a></h2>
<h3 id="_3-4-1-api-相关" tabindex="-1"><a class="header-anchor" href="#_3-4-1-api-相关"><span>3.4.1.API 相关</span></a></h3>
<ul>
<li>语法: object mergeObject(...objs)</li>
<li>功能: 合并多个对象, 返回一个合并后对象(不改变原对象)</li>
<li>例子:
<ul>
<li>{ a: [{ x: 2 }, { y: 4 }], b: 1}</li>
<li>{ a: { z: 3}, b: [2, 3], c: 'foo'}</li>
<li>合并后: { a: [ { x: 2 }, { y: 4 }, { z: 3 } ], b: [ 1, 2, 3 ], c: 'foo' }</li>
</ul>
</li>
</ul>
<h3 id="_3-4-2-编码实现" tabindex="-1"><a class="header-anchor" href="#_3-4-2-编码实现"><span>3.4.2.编码实现</span></a></h3>
<ul>
<li><code v-pre>src/object/mergeObject.js</code></li>
</ul>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code class="language-javascript"><span class="line"><span class="token keyword">export</span> <span class="token keyword">function</span> <span class="token function">mergeObject</span><span class="token punctuation">(</span><span class="token parameter"><span class="token operator">...</span>objs</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>html</span><span class="token punctuation">></span></span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-5-对象-数组拷贝" tabindex="-1"><a class="header-anchor" href="#_3-5-对象-数组拷贝"><span>3.5. 对象/数组拷贝</span></a></h2>
<h3 id="_3-5-1-区别浅拷贝与深拷贝" tabindex="-1"><a class="header-anchor" href="#_3-5-1-区别浅拷贝与深拷贝"><span>3.5.1.区别浅拷贝与深拷贝</span></a></h3>
<ul>
<li>纯语言表达:
<ul>
<li>浅拷贝: 只是复制了对象属性或数组元素本身(只是引用地址值)</li>
<li>深拷贝: 不仅复制了对象属性或数组元素本身, 还复制了指向的对象(使用递归)</li>
</ul>
</li>
<li>举例说明: 拷贝persons数组(多个人对象的数组)
<ul>
<li>浅拷贝: 只是拷贝了每个person对象的引用地址值, 每个person对象只有一份</li>
<li>深拷贝: 每个person对象也被复制了一份新的</li>
</ul>
</li>
</ul>
<h3 id="_3-5-2-实现浅拷贝" tabindex="-1"><a class="header-anchor" href="#_3-5-2-实现浅拷贝"><span>3.5.2.实现浅拷贝</span></a></h3>
<ul>
<li><code v-pre>src/object/clone.js</code></li>
</ul>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-5-3-实现深拷贝" tabindex="-1"><a class="header-anchor" href="#_3-5-3-实现深拷贝"><span>3.5.3.实现深拷贝</span></a></h3>
<ul>
<li>实现一: 大众乞丐版
<ul>
<li>问题1: 函数属性会丢失</li>
...
<li>实现四: 面试加强版本2(优化遍历性能)
<ul>
<li>数组: while | for | forEach() 优于 for-in | keys()&amp;forEach()</li>
<li>对象: for-in 与 keys()&amp;forEach() 差不多</li>
</ul>
</li>
<li>编码实现: src/object/deepClone.js</li>
</ul>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code class="language-javascript"><span class="line"><span class="token comment">/* </span>
