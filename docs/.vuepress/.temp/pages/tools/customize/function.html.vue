<template><div><h1 id="_1、函数相关" tabindex="-1"><a class="header-anchor" href="#_1、函数相关"><span>1、函数相关</span></a></h1>
<h2 id="_1-1-call-apply-bind" tabindex="-1"><a class="header-anchor" href="#_1-1-call-apply-bind"><span>1.1.call()&amp; apply()&amp; bind()</span></a></h2>
<h3 id="_1-1-1api说明" tabindex="-1"><a class="header-anchor" href="#_1-1-1api说明"><span>1.1.1Api说明</span></a></h3>
<ul>
<li>call()
<ul>
<li>语法: call(fn, obj, ...args)</li>
<li>功能: 执行fn, 使this为obj, 并将后面的n个参数传给fn(功能等同于函数对象的call方法)</li>
</ul>
</li>
<li>apply()
<ul>
<li>语法: apply(fn, obj, args)</li>
<li>功能: 执行fn, 使this为obj, 并将args数组中的元素传给fn(功能等同于函数对象的apply方法)</li>
</ul>
</li>
<li>bind()
<ul>
<li>语法: bind(fn, obj, ...args)</li>
<li>功能: 给fn绑定this为obj, 并指定参数为后面的n个参数 (功能等同于函数对象的bind方法)</li>
</ul>
</li>
</ul>
<h3 id="_1-1-2-实现说明" tabindex="-1"><a class="header-anchor" href="#_1-1-2-实现说明"><span>1.1.2.实现说明</span></a></h3>
<ul>
<li>区别call()/apply()/bind()
<ul>
<li>call(obj)/apply(obj): 调用函数, 指定函数中的this为第一个参数的值</li>
<li>bind(obj): 返回一个新的函数, 新函数内部会调用原来的函数, 且this为bind()指定的第一参数的值</li>
<li>注意: 如果obj是null/undefined, this为window</li>
</ul>
</li>
<li>应用
<ul>
<li>call()/apply()应用: 根据伪数组生成真数组</li>
<li>bind(): react中组件的自定义方法 / vue中的事件回调函数内部</li>
</ul>
</li>
<li>自定义call()/apply()
<ul>
<li>给obj添加一个临时方法, 方法名任意, 值为当前函数</li>
<li>通过obj调用这个临时方法, 并将接收的参数传入</li>
<li>删除obj上的这个临时方法属性</li>
</ul>
</li>
<li>自定义实现bind()
<ul>
<li>返回一个新函数</li>
<li>在新函数内部通过原函数对象的call方法来执行原函数</li>
<li>指定原函数的this为obj</li>
<li>指定参数为bind调用的参数和后面新函数调用的参数</li>
</ul>
</li>
</ul>
<h3 id="_1-1-3-编码实现" tabindex="-1"><a class="header-anchor" href="#_1-1-3-编码实现"><span>1.1.3.编码实现</span></a></h3>
<ul>
<li>自定义函数对象的call方法: <code v-pre>src/function/call.js</code></li>
</ul>
...
<li>自定义函数对象的apply方法: <code v-pre>src/function/apply.js</code></li>
</ul>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code class="language-javascript"><span class="line"><span class="token comment">/* </span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>自定义函数对象的bind方法: <code v-pre>src/function/bind.js</code></li>
</ul>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code class="language-javascript"><span class="line"><span class="token keyword">import</span> <span class="token punctuation">{</span>call<span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'./call'</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-2-函数节流与函数防抖" tabindex="-1"><a class="header-anchor" href="#_1-2-函数节流与函数防抖"><span>1.2.函数节流与函数防抖</span></a></h2>
<h3 id="_1-2-1-相关理解" tabindex="-1"><a class="header-anchor" href="#_1-2-1-相关理解"><span>1.2.1.相关理解</span></a></h3>
<ul>
<li>事件频繁触发可能造成的问题?
<ul>
<li>一些浏览器事件:window.onresize、window.mousemove等，触发的频率非常高，会造成界面卡顿</li>
<li>如果向后台发送请求，频繁触发，对服务器造成不必要的压力</li>
</ul>
</li>
<li>如何限制事件处理函数频繁调用
<ul>
...
<li>理解:
<ul>
<li>在函数需要频繁触发时: 函数执行一次后，只有大于设定的执行周期后才会执行第二次</li>
<li>适合多次事件按时间做平均分配触发</li>
</ul>
</li>
<li>场景：
<ul>
...
<li>理解:
<ul>
<li>在函数需要频繁触发时: 在规定时间内，只让最后一次生效，前面的不生效。</li>
<li>适合多次事件一次响应的情况</li>
</ul>
</li>
<li>场景:
<ul>
<li>输入框实时搜索联想（keyup/input）</li>
</ul>
</li>
</ul>
</li>
<li>区别函数节流与防抖
<img src="@source/tools/customize/img.png" alt="png"></li>
</ul>
<h3 id="_1-2-2-api说明" tabindex="-1"><a class="header-anchor" href="#_1-2-2-api说明"><span>1.2.2.API说明</span></a></h3>
<ul>
<li>throttle() 节流
<ul>
<li>语法: throttle(callback, wait)</li>
<li>功能: 创建一个节流函数，在 wait 毫秒内最多执行 callback 一次</li>
</ul>
</li>
<li>debounce() 防抖
<ul>
<li>语法: debounce(callback, wait)</li>
<li>功能: 创建一个防抖动函数，该函数会从上一次被调用后，延迟 wait 毫秒后调用 callback</li>
</ul>
</li>
</ul>
<h3 id="_1-2-3-编码实现" tabindex="-1"><a class="header-anchor" href="#_1-2-3-编码实现"><span>1.2.3.编码实现</span></a></h3>
<ul>
<li><code v-pre>src/function/throttle.js</code>:函数节流</li>
</ul>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code class="language-javascript"><span class="line"><span class="token comment">/* </span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li><code v-pre>src/function/debounce.js</code>:函数防抖</li>
</ul>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code class="language-javascript"><span class="line"><span class="token comment">/* </span>
